...
public class BlockInit {
	...
	public static final RegistryObject<Block> COBALT_BLOCK = BLOCKS.register("cobalt_block",
			() -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(5.0F, 6.0F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(4).sound(SoundType.METAL).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> ROSE_QUARTZ_BLOCK = BLOCKS.register("rose_quartz_block",
			() -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(0.8F, 0.8F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.METAL).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> SHADOW_BLOCK = BLOCKS.register("shadow_block",
			() -> new Block(AbstractBlock.Properties.of(Material.METAL).strength(5.0F, 6.0F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(5).sound(SoundType.METAL).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<AlloySynthesizerBlock> ALLOY_SYNTHESIZER = BLOCKS.register("alloy_synthesizer", 
			() -> new AlloySynthesizerBlock(AbstractBlock.Properties.of(Material.METAL).strength(4, 4).harvestTool(ToolType.PICKAXE).harvestLevel(1)
					.sound(SoundType.METAL).requiresCorrectToolForDrops()));
	public static final RegistryObject<JewelerBarrelBlock> JEWELER_BARREL = BLOCKS.register("jeweler_barrel", 
		 () -> new JewelerBarrelBlock(AbstractBlock.Properties.of(Material.WOOD).strength(4, 4)
				 .harvestTool(ToolType.AXE).harvestLevel(0).sound(SoundType.WOOD).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> DIAMOND_LANTERN = BLOCKS.register("diamond_lantern", 	
			() -> new Block(AbstractBlock.Properties.of(Material.GLASS).strength(0.6F, 0.6F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(1).sound(SoundType.GLASS).requiresCorrectToolForDrops()));
	
	public static final RegistryObject<DarkMatterBlock> DARK_MATTER = BLOCKS.register("dark_matter", 
			() -> new DarkMatterBlock(AbstractBlock.Properties.of(Material.EXPLOSIVE).instabreak().sound(SoundType.GRASS)));
	...
	public static final RegistryObject<Block> ALEXANDRITE_ORE = BLOCKS.register("alexandrite_ore",
			() -> new Block(AbstractBlock.Properties.of(Material.STONE).strength(3.0F, 3.0F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(3).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> COBALT_ORE = BLOCKS.register("cobalt_ore",
			() -> new Block(AbstractBlock.Properties.of(Material.STONE).strength(3.0F, 3.0F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(4).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	public static final RegistryObject<Block> JASPER_ORE = BLOCKS.register("jasper_ore",
			() -> new Block(AbstractBlock.Properties.of(Material.STONE).strength(3.0F, 3.0F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(2).sound(SoundType.STONE).requiresCorrectToolForDrops()));
	...
	public static final RegistryObject<Block> SHADOW_ORE = BLOCKS.register("shadow_ore",
			() -> new Block(AbstractBlock.Properties.of(Material.STONE).strength(3.0F, 3.0F)
					.harvestTool(ToolType.PICKAXE).harvestLevel(5).sound(SoundType.STONE).requiresCorrectToolForDrops()));
