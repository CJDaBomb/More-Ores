...
public class PurpleRedstoneWireBlock extends Block {
    ...
    public PurpleRedstoneWireBlock(AbstractBlock.Properties p_i48344_1_) {
        super(p_i48344_1_);
    ...
    public @NotNull VoxelShape getShape(BlockState p_220053_1_, @NotNull IBlockReader p_220053_2_, @NotNull BlockPos p_220053_3_, @NotNull ISelectionContext p_220053_4_) {
    ...
    @SuppressWarnings("deprecation")
    public @NotNull BlockState updateShape(@NotNull BlockState p_196271_1_, @NotNull Direction p_196271_2_, @NotNull BlockState p_196271_3_, @NotNull IWorld p_196271_4_, @NotNull BlockPos p_196271_5_, @NotNull BlockPos p_196271_6_) {
    ...
    @SuppressWarnings("deprecation")
    public void updateIndirectNeighbourShapes(@NotNull BlockState p_196248_1_, @NotNull IWorld p_196248_2_, @NotNull BlockPos p_196248_3_, int p_196248_4_, int p_196248_5_) {
    ...
    @SuppressWarnings("deprecation")
    public boolean canSurvive(@NotNull BlockState p_196260_1_, IWorldReader p_196260_2_, BlockPos p_196260_3_) {
    ...
    @SuppressWarnings("deprecation")
    public void onPlace(BlockState p_220082_1_, @NotNull World p_220082_2_, @NotNull BlockPos p_220082_3_, @NotNull BlockState p_220082_4_, boolean p_220082_5_) {
    ...
    public void onRemove(@NotNull BlockState p_196243_1_, @NotNull World p_196243_2_, @NotNull BlockPos p_196243_3_, @NotNull BlockState p_196243_4_, boolean p_196243_5_) {
        if (!p_196243_5_ && !p_196243_1_.is(p_196243_4_.getBlock())) {
            super.onRemove(p_196243_1_, p_196243_2_, p_196243_3_, p_196243_4_, false);
    ...
    @SuppressWarnings("deprecation")
    public void neighborChanged(@NotNull BlockState p_220069_1_, World p_220069_2_, @NotNull BlockPos p_220069_3_, @NotNull Block p_220069_4_, @NotNull BlockPos p_220069_5_, boolean p_220069_6_) {
    ...
    @SuppressWarnings("deprecation")
    public @NotNull ActionResultType use(@NotNull BlockState p_225533_1_, @NotNull World p_225533_2_, @NotNull BlockPos p_225533_3_, PlayerEntity p_225533_4_, @NotNull Hand p_225533_5_, @NotNull BlockRayTraceResult p_225533_6_) {
