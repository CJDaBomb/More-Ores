...
public class TurquoiseShovelItem extends ShovelItem {
    public TurquoiseShovelItem(IItemTier p_i48530_1_, float p_i48530_2_, float p_i48530_3_, Properties p_i48530_4_) {
