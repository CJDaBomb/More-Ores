...
public class JewelerBarrelContainer extends Container {
	...
	public JewelerBarrelContainer(final int windowId, final PlayerInventory playerInv, final JewelerBarrelTileEntity te) {
	...
	public ItemStack transferStackInSlot(PlayerEntity playerIn, int index) {
		...
		if (slot != null && slot.getHasStack()) {
			...
			stack = stack2.copy();
			if (index < 36 && !this.mergeItemStack(stack2, JewelerBarrelTileEntity.slots, this.inventorySlots.size(), true)) {
