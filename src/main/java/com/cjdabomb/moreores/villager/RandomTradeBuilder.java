...
public class RandomTradeBuilder
{
    ...
    public RandomTradeBuilder setRoseQuartzPrice(int rose_quartz)
    {
        return this.setPrice((random) -> new ItemStack(ItemInit.ROSE_QUARTZ.get(), rose_quartz));
    }
    
    public RandomTradeBuilder setRoseQuartzPriceFor(int rose_quartz, Item item, int amt)
    {
        this.setRoseQuartzPrice(rose_quartz);
        return this.setForSale((random) -> new ItemStack(item, amt));
    }
    
    public RandomTradeBuilder setRoseQuartzPriceFor(int rose_quartz, Item item)
    {
        return this.setRoseQuartzPriceFor(rose_quartz, item, 1);
    }
    
    public RandomTradeBuilder setRoseQuartzPrice(int min, int max)
    {
        return this.setPrice(ItemInit.ROSE_QUARTZ.get(), min, max);
    }
    
    public RandomTradeBuilder setRoseQuartzPriceFor(int min, int max, Item item, int amt)
    {
        this.setRoseQuartzPrice(min, max);
        return this.setForSale((random) -> new ItemStack(item, amt));
    }
    
    public RandomTradeBuilder setRoseQuartzPriceFor(int min, int max, Item item)
    {
        return this.setRoseQuartzPriceFor(min, max, item, 1);
    }
